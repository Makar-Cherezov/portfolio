...
const experience = [
  {
    ...
    description: "Работа в формате стартапов и лабораторий инноваций. Проектирование систем с внедрением AI.",
    projects: [
      {
    ...
    projects: [
      ...
      },
      {
        ...
        tasks: [
          ...
          "Провел онбординг нового администратора проекта по своим методическим материалам.", 
